...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artArrayList = new ArrayList<>(); //başta boş

        binding.recyclerView.setLayoutManager(new LinearLayoutManager(this));//alt alta gözükücek
    ...
    public void getData(){ // databaseye kaydedilen artları main activityde kaydetme
        ...
        try {
            ...
            artAdapter.notifyDataSetChanged(); // veri seti değişince güncellemeyi sağlıyor maini
            cursor.close();
